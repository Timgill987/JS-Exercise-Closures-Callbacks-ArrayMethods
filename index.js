...
function processSum(numberList, callback) {
  const total = (total, currentValue) => (total += currentValue); // total = total + currentValue
...
function getRunnersByTShirtSize(runners, tShirtSize) {
  const tShirtrunner = runners.filter(function(currentValue) {
...
function tallyUpDonations(runners) {
  let totalDonations = runners.reduce(function(accum, currentValue){
